                    ...
                    if (dataSnapshot.exists()){
                        ...
                        if (dataSnapshot.hasChild("Security Questions")){
                            ...
                            if (!ans1.equals(answer1)){
                                ...
                                builder.setPositiveButton("Chamge", new DialogInterface.OnClickListener() {
                                    @Override
                            ...
                            Toast.makeText(ResetPasswordActivity.this, "you have not set security questios..", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else {
